...
This means the workspace admin has restricted direct messaging to bots. You have two options:

**Option A — Use channels only (recommended):**

- Skip DMs entirely
- Add the bot to specific channels you want to monitor (Step 7)
- The bot will receive messages from channels it's added to, even if DMs are disabled

**Option B — Request admin permission:**

- Ask your Slack workspace admin to enable "Allow members to send direct messages to bots and apps"
- In Slack workspace settings: **Workspace Settings** → **Permissions** → **App Configuration**
- Enable "Allow members to send direct messages to bots and apps"

If you're the admin, you can enable this in **[slack.com/admin/settings](https://slack.com/admin/settings)** → **Permissions** → **App Configuration**.
